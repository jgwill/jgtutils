...
from jgtutils.statemachine.model import StateMachineDefinition, SettingsModel
from jgtutils.statemachine.parser import StateMachineParser
from jgtutils.statemachine.codegen import generate_python, PythonCodeGenerator
...
EXAMPLE_DIR = os.path.join(os.path.dirname(__file__), "..", "jgtutils", "statemachine", "examples")
...
def test_cli_validate():
    ...
    from jgtutils.statemachine.cli import main
    import sys
